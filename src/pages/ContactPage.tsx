...
export default function ContactPage() {
  return (
    <>
      <PageHeader
        kicker="Get In Touch"
        title="Visit or Order from Us"
        subtitle="We'd love to hear from you. Reach out anytime — we respond fast."
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="flex gap-3 pt-3">
                <a
                  href={`tel:${PHONE}`}
                  className="flex-1 text-center px-5 py-3 rounded-full bg-[color:var(--royal)] text-[color:var(--royal-foreground)] font-semibold hover:bg-[color:var(--accent)] transition-colors"
                >
                  Call Now
                </a>
