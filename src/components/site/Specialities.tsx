  ...
  return (
    <section className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <SectionTitle
          kicker="Explore"
          title="Premium Printing & Packaging"
          subtitle="Customized sweet boxes, wedding gifts, return gifts, festival hampers, and corporate branding crafted with premium quality and elegant designs."
        />
