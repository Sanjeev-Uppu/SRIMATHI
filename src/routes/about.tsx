...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Srimathi Foods preserves traditional flavors while delivering premium sweets, hot snacks, home foods, and prasadams." },
      { property: "og:title", content: "About Srimathi Foods" },
      { property: "og:description", content: "Authentic recipes passed through generations — crafted with devotion." },
    ],
...
function AboutPage() {
  return (
    <>
      <PageHeader kicker="About Us" title="About Srimathi Foods" subtitle="Preserving traditional flavors with premium quality and devotion." />
