...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Srimathi Foods — Traditional Sweets & Prasadams" },
      { name: "description", content: "Traditional sweets, prasadams, home foods, hot snacks & customized gift boxes." },
      { name: "author", content: "Srimathi Foods" },
      { property: "og:site_name", content: "Srimathi Foods" },
