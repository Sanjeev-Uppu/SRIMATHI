...
import { FaGift, FaBoxOpen, FaBirthdayCake, FaPrint } from "react-icons/fa";
import { PageHeader, LazyImage, craftModules, fadeUp } from "@/components/site/shared";

export const Route = createFileRoute("/specialties")({
  head: () => ({
    meta: [
      { title: "Specialties — Srimathi Foods" },
      { name: "description", content: "Custom printed sweet boxes, premium gift packaging, special crafts and event orders for weddings and corporate." },
      { property: "og:title", content: "Specialties — Srimathi Foods" },
      { property: "og:description", content: "Custom-printed boxes, premium packaging, and event orders handled with precision." },
    ],
